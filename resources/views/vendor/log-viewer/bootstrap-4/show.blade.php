...
@section('title')
      ...
      <ol class="breadcrumb">
        <li><a href="{{ route('log-viewer::logs.list') }}"><i class="fa fa-archive"></i> Logs </a></li>
...
@section('main')
    <div class="row">
        <div class="col-lg-2">
            {{-- Log Menu --}}
            <div class="card mb-4">
                <div class="card-header"><i class="fa fa-fw fa-flag"></i> Niveaux </div>
                ...
                <div class="card-footer">
                    ...
                    <form action="{{ route('log-viewer::logs.search', [$log->date, $level]) }}" method="GET">
                        <div class="form-group">
                                ...
                                <input id="query" name="query" class="form-control"  value="{!! $query !!}" placeholder="Tapez votre recherche">
                                </div>
                                    ...
                                    <td class="text-right">
                                        @if ($entry->hasStack())
                                            <a class="btn btn-sm btn-light" role="button" data-toggle="collapse" href="#log-stack-{{ $key }}" aria-expanded="false" aria-controls="log-stack-{{ $key }}">
                                                <i class="fa fa-toggle-on"></i> Détail
                                            </a>
                                        @endif
                                    </td>
                                </tr>
